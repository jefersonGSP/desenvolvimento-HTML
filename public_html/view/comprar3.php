...
<div class="container-fliud wrapper ">
  ...
  background: scroll center
    url('https://pbs.twimg.com/profile_images/680604705211428864/hFN8euCM_400x400.png');
...
">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="../controller/resultados.php" method="POST">
                            ...
                            <hr class="my-4">
                            <br>
                            <button class="btn btn-lg  btn-block text-uppercase" style="background: linear-gradient(to right, #8512a8, #e8eb3b);" type="submit">Comprar $300</button>
                            <br>
                        </form>
                    </div>
                </div>
