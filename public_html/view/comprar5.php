...
<body>
<div class="container-fliud wrapper ">        <div class="row ">
            <div class="col-lg-10 col-xl-9 mx-auto ">
                <div class="card card-signin flex-row my-5">
                    <div class="card-img-left d-none d-md-flex" style=" width: 50%;
  background: scroll center
    url('https://images2.alphacoders.com/208/thumb-1920-208802.jpg');
...
">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="../controller/resultados.php" method="POST">
                            ...
                            <hr class="my-4">
                            <br>
                            <button class="btn btn-lg  btn-block text-uppercase" style="background: linear-gradient(to right, #8512a8, #e8eb3b);" type="submit">Comprar $123.456.678.900,00</button>
                            <br>
                        </form>
                    </div>
                </div>
