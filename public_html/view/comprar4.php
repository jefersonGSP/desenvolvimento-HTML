...
<div class="container-fliud wrapper ">        <div class="row ">
  ...
  background: scroll center
    url('https://img.olx.com.br/thumbs256x256/04/040012019693890.jpg');
...
">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="../controller/resultados.php" method="POST">
                            ...
                            <hr class="my-4">
                            <br>
                            <button class="btn btn-lg  btn-block text-uppercase" style="background: linear-gradient(to right, #8512a8, #e8eb3b);" type="submit">Comprar $102</button>
                            <br>
                        </form>
                    </div>
                </div>
