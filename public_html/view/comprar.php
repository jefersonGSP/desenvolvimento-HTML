...
<body>
  ...
  background: scroll center
    url('https://s2.glbimg.com/tBChOKSHQXVrtC_ADbV1Dv3tQbA=/e.glbimg.com/og/ed/f/original/2015/02/05/pombo1.jpg');
...
">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" action="../controller/resultados.php" method="POST">
                            ...
                            <hr class="my-4">
                            <br>
                            <button class="btn btn-lg  btn-block text-uppercase" style="background: linear-gradient(to right, #8512a8, #e8eb3b);" type="submit">Comprar $10</button>
                            <br>
                        </form>
                    </div>
                </div>
